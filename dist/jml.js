(function (global, factory) {
  ...
  */
   ...
   * } & DataAttribute & StyleAttribute} JamilihAttributes
   */
   ...
   * @param {JamilihAttValue|null} attVal
          ...
          case '$define':
            {
              ...
              const getConstructor = cnstrct => {
                ...
                const baseClass = options && typeof options.extends === 'string' ? /** @type {typeof HTMLElement} */doc.createElement(options.extends).constructor : customizedBuiltIn ? /** @type {typeof HTMLElement} */doc.createElement(localName).constructor : window.HTMLElement;
          ...
          default:
            {
              ...
              if (att === 'style') {
                attVal = /** @type {string} */checkPluginValue(elem, att, attVal, opts);
                if (_isNullish(attVal)) {
                  break;
                }
              ...
              switch (childContentType) {
                ...
                default:
                  ...
                  if (Array.isArray(childContent)) {
                    ...
                    const newChildContent = /** @type {string} */
