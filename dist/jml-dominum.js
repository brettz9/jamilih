...
function Node$1(cfg) {
  ...
  Object.defineProperties(this, {
    ...
    textContent: {
      get: function () {
        if (this.nodeType == Node$1.TEXT_NODE) {
          return this.text;
        } else {
...
Node$1.prototype.getAttribute = function (attributeName) {
...
Node$1.prototype.getElementsByTagName = function (tagName) {
  return searchElements(this, function (elem) {
    return elem.nodeName == tagName;
  });
};

Node$1.prototype.getElementsByClassName = function (className) {
...
Node$1.prototype.getElementById = function (id) {
  return searchElements(this, function (elem) {
    return elem.attributes.length && elem.getAttribute('id') == id;
  }, true);
};

Node$1.prototype.getElementsByName = function (name) {
  return searchElements(this, function (elem) {
    return elem.attributes.length && elem.getAttribute('name') == name;
  });
};

Node$1.ELEMENT_NODE = 1;
Node$1.TEXT_NODE = 3;
var Node_1 = Node$1;
  ...
  for (var i = 0, l = tags.length; i < l; i++) {
    ...
    if (composing) {
      if (startTagExp.test(tag)) {
        ...
        (currentObject && currentObject.childNodes || result).push(buffer = new Node_1({
          nodeType: 1,
          //element node
        ...
        currentObject.childNodes.push(new Node_1({
          nodeType: 3,
          text: tag,
          parentNode: currentObject
        }));
...
if (typeof process !== 'undefined') {
  var doc$1 = createHTMLDocument(); // Todo: Could make DOMParser and XMLSerializer optional as not really
