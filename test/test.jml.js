...
import {$, jml, body} from '../test-helpers/loadTests-node.js';
...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta charset="utf-8" /><meta name="webappfind" /></head><body><p></p></body></html>`
  ...
  it('Symbol', () => {
    ...
    jml('div', [
      ...
      ['div', {id: 'divSymbolTest', $on: /** @type {import('../src/jml.js').HandlerAttribute} */ ({
        click () {
  ...
  it('Custom elements', () => {
    ...
    if (!window.customElements) {
      ...
      const myel5 = /** @type {Element & {test: (arg1: string) => void, test2: (arg1: string) => void}} */ (jml('my-el5', {
        id: 'myEl5',
        $define: [class extends /** @type {import('jsdom').DOMWindow} */ (
          win
        ).HTMLElement {
  ...
  it('Custom Elements - 3', function () {
    if (!window.customElements) {
      ...
      const myButton9 = /** @type {Element & {test: () => string}} */ (jml('button', {
        id: 'myButton9',
        is: 'x-button3',
        $define: [
          function () {
      ...
      const myButton10 = /** @type {Element & {test: () => string}} */ (jml('button', {
        id: 'myButton10',
        is: 'x-button4',
        $define: [
          function () {
